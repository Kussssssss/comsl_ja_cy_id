...
CV_root = r"cv-corpus-11.0-2022-09-21-id/cv-corpus-11.0-2022-09-21" 
data_language = "indonesian"  # TODO: set your data language, e.g. 'french', 'chinese'
cfg.mbart_model_path = "facebook/mbart-large-50-many-to-many-mmt"  # TODO: set your mBART model path to your pretrained model
output_dir = f"/kaggle/working/comsl_ja_cy_id/{CV_root}/psudo"
